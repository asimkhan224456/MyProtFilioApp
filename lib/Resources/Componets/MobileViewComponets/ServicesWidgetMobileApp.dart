...
class ServicesWidgetMobileApp extends StatefulWidget {
  const ServicesWidgetMobileApp({ Key? key }) : super(key: key);

  @override
  _ServicesWidgetMobileAppState createState() => _ServicesWidgetMobileAppState();
}

class _ServicesWidgetMobileAppState extends State<ServicesWidgetMobileApp> {
  @override
 ...
 Row(
      ...
      Padding(
        ...
        child: Column(
          children: <Widget>[
           Container(child: LottieBuilder.asset(AppAssetsConfig.MobileAppServiceAnimation,height: 200,width: 400,))
