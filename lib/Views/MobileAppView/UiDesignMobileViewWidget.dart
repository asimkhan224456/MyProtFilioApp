...
class UiDesignMobileViewWidget extends StatefulWidget {
  const UiDesignMobileViewWidget({ Key? key }) : super(key: key);

  @override
  _UiDesignMobileViewWidgetState createState() => _UiDesignMobileViewWidgetState();
}

class _UiDesignMobileViewWidgetState extends State<UiDesignMobileViewWidget> {
  @override
...
SizedBox(
 ...
 Row(
  ...
  child: LottieBuilder.asset(AppAssetsConfig.UiDesignAnimation,height: 200,width: 200),
  )
